  ...
  return (
    <div className="flex min-h-screen">
      <div className="w-1/3 relative bg-black text-white">
        ...
        <div className="relative z-10 p-12 h-full flex flex-col justify-center">
          {[
            ...
            { step: "Étape 3", label: "Prise du rendez-vous", active: true },
            ...
            <div key={index} className="flex items-start ml-20 gap-4">
              <div className="flex flex-col items-center">
                ...
                {index !== 3 && <div className="h-20 w-0.5 bg-white" />}
              </div>
              <div>
      ...
      <div className="w-2/3 bg-gray-100 p-8 relative">
        ...
        <h1 className="text-3xl font-bold mb-6 mt-15 text-gray-800 flex items-center justify-center">Prendre un rendez-vous</h1>
