...
import InternationalCarForm from "@/components/InternationalCarForm"
import { DropDownMenu } from "@/components/DropDownMenu"
const handleCarCreated = (newCar: any) => {
  console.log("New car created:", newCar);
};
export default function InternationalCarPage() {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-2/3 bg-gray-100 p-8 relative">
        ...
        <h1 className="text-3xl font-bold mb-6 mt-30 text-gray-800 mb-20 ml-30">Voiture Étrangère</h1>
